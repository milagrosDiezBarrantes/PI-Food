...
export default function Pagination({page, setPage, recipesPerPage}){
    ...
    return(
       <DivStylePag>
            ...
            <p>de {recipesPerPage}</p>
            <StyledButtonsPag disabled={page === 12 || page > 12} onClick={nextPage}>⇢</StyledButtonsPag>
        </DivStylePag>
    )
